<?php use MHW\Support; $title = 'Le mie guide'; $nav = 'pannello'; ?>
<div class="spread"><h1>Le mie guide.</h1><a class="btn" href="/pannello/nuova">Aggiungi una struttura</a></div>
<?php if ($sub): ?>
...
<?php else: ?>
  ...
  <a href="/">Guardate i piani</a>.</p>
<?php endif; ?>
<div class="list" style="margin-top:24px">
  <?php foreach ($props as $p): ?>
    <a class="list-item" href="/pannello/<?= (int) $p['id'] ?>">
