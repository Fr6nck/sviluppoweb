<?php use function MHW\b; use MHW\{Support, Csrf}; $title = 'Accesso'; ?>
<h1>Bentornati.</h1>
...
<p class="small muted" style="margin-top:16px">Non avete un account? <a href="<?= b() ?>/registrati">Createne uno</a>.</p>
