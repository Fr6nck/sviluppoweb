...
INSERT INTO rooms (id, ref, position, published, confirmed, name_confirmed, type_key,
  ...
  VALUES (1, 'camera-01', 1, 1, 0, 0, 'twin', 2, 2, '{"single":2}', '["double","twin"]', NULL, NULL, 'demo', '{"private":true,"shower":true,"bathtub":false}', 0, 'EUR', 85, 1);
...
INSERT INTO room_images (room_id, role, path, ratio, alt, position, credit)
  VALUES (1, 'card', 'img/camere/camera-01-4x3', '4/3', NULL, 0, 'segnaposto disegnato — sostituire con la fotografia vera');
INSERT INTO room_images (room_id, role, path, ratio, alt, position, credit)
  VALUES (1, 'list', 'img/camere/camera-01-3x2', '3/2', NULL, 0, 'segnaposto disegnato — sostituire con la fotografia vera');
INSERT INTO room_images (room_id, role, path, ratio, alt, position, credit)
  VALUES (1, 'hero', 'img/camere/camera-01-16x9', '16/9', NULL, 0, 'segnaposto disegnato — sostituire con la fotografia vera');
INSERT INTO room_images (room_id, role, path, ratio, alt, position, credit)
  VALUES (1, 'gallery', 'img/camere/camera-01-1x1', '1/1', NULL, 10, 'segnaposto disegnato — sostituire con la fotografia vera');
INSERT INTO room_images (room_id, role, path, ratio, alt, position, credit)
...
INSERT INTO rooms (id, ref, position, published, confirmed, name_confirmed, type_key,
                   ...
                   size_sqm, floor, view_key, bathroom_json,
                   price_confirmed, currency, base_rate, view_san_rufino)
  VALUES (2, 'camera-02', 2, 1, 0, 0, 'twin', 2, 2, '{"single":2}', '["double","twin"]', NULL, NULL, 'demo', '{"private":true,"shower":true,"bathtub":false}', 0, 'EUR', 90, 1);
...
INSERT INTO prices (room_id, nightly_rate, currency, min_nights, confirmed) VALUES (2, 90, 'EUR', 1, 0);

INSERT INTO rooms (id, ref, position, published, confirmed, name_confirmed, type_key,
                   occupancy_standard, occupancy_max, beds_json, layouts_json,
                   size_sqm, floor, view_key, bathroom_json,
                   price_confirmed, currency, base_rate, view_san_rufino)
  VALUES (3, 'camera-03', 3, 1, 0, 0, 'twin', 2, 2, '{"single":2}', '["double","twin"]', NULL, NULL, 'demo', '{"private":true,"shower":true,"bathtub":false}', 0, 'EUR', 85, 1);
...
INSERT INTO room_amenities (room_id, amenity_key, position) VALUES (3, 'wardrobe', 60);
INSERT INTO room_images (room_id, role, path, ratio, alt, position, credit)
...
INSERT INTO rooms (id, ref, position, published, confirmed, name_confirmed, type_key,
                   ...
                   size_sqm, floor, view_key, bathroom_json,
                   price_confirmed, currency, base_rate, view_san_rufino)
  VALUES (4, 'camera-04', 4, 1, 0, 0, 'double', 2, 2, '{"single":2,"double":1}', '["double","twin"]', NULL, NULL, 'demo', '{"private":true,"shower":true,"bathtub":false}', 0, 'EUR', 95, NULL);
...
INSERT INTO room_amenities (room_id, amenity_key, position) VALUES (4, 'desk', 60);
INSERT INTO room_images (room_id, role, path, ratio, alt, position, credit)
...
INSERT INTO prices (room_id, nightly_rate, currency, min_nights, confirmed) VALUES (4, 95, 'EUR', 1, 0);

INSERT INTO rooms (id, ref, position, published, confirmed, name_confirmed, type_key,
                   occupancy_standard, occupancy_max, beds_json, layouts_json,
                   size_sqm, floor, view_key, bathroom_json,
                   price_confirmed, currency, base_rate, view_san_rufino)
  VALUES (5, 'camera-05', 5, 1, 0, 0, 'triple', 2, 3, '{"single":1,"double":1}', '["double","triple"]', NULL, NULL, 'demo', '{"private":true,"shower":true,"bathtub":false}', 0, 'EUR', 110, NULL);
...
INSERT INTO prices (room_id, nightly_rate, currency, min_nights, confirmed) VALUES (5, 110, 'EUR', 1, 0);
